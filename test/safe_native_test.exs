defmodule SafeNativeTest do
  ...
  describe "include modules" do
    test "mix test" do
      ...
      System.cmd("mix", ["deps.update", "--all"], cd: "test_support/sub1", into: IO.stream())
      System.cmd("mix", ["deps.update", "--all"], cd: "test_support/sub2", into: IO.stream())
      System.cmd("mix", ["deps.update", "--all"], cd: "test_support/include_modules", into: IO.stream())
